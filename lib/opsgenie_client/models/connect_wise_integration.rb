...
module OpsgenieClient
  ...
  class ConnectWiseIntegration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'awsLambdaUrl')
        self.aws_lambda_url = attributes[:'awsLambdaUrl']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          aws_lambda_url == o.aws_lambda_url &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, aws_lambda_url, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
