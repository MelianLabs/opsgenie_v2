...
module OpsgenieClient
  ...
  class DeskCallback
    ...
    def hash
      [alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, consumer_key, consumer_key_secret, access_token, access_token_secret, subdomain].hash
    end
