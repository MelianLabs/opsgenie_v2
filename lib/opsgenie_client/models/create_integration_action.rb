...
module OpsgenieClient
  ...
  class CreateIntegrationAction
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["ignore", "acknowledge", "addNote", "close", "create"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["ignore", "acknowledge", "addNote", "close", "create"])
    ...
    def hash
      [user, note, _alias, name, order, filter, type, source, message, description, entity, priority, append_attachments, alert_actions, ignore_alert_actions_from_payload, recipients, ignore_recipients_from_payload, ignore_teams_from_payload, tags, ignore_tags_from_payload, extra_properties, ignore_extra_properties_from_payload].hash
    end
