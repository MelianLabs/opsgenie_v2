...
module OpsgenieClient
  ...
  class OpsgenieIntegration
    ...
    attr_accessor :destination_api_key
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'destinationApiKey')
        self.destination_api_key = attributes[:'destinationApiKey']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          destination_api_key == o.destination_api_key &&
          api_key == o.api_key &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, destination_api_key, api_key, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
