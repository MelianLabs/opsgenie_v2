...
module OpsgenieClient
  ...
  class StatusIOCallback
    ...
    def hash
      [alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, status_io_api_id, status_io_api_key, status_io_status_page_id].hash
    end
