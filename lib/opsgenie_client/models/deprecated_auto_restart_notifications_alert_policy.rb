...
module OpsgenieClient
  ...
  class DeprecatedAutoRestartNotificationsAlertPolicy
    attr_accessor :id
    ...
    # Duration to wait before restarting the notification flow
    attr_accessor :duration

    # Max restart count of the notification flow
    attr_accessor :max_repeat_count
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'maxRepeatCount')
        self.max_repeat_count = attributes[:'maxRepeatCount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          duration == o.duration &&
          max_repeat_count == o.max_repeat_count
    end
    ...
    def hash
      [id, name, policy_description, filter, time_restrictions, enabled, type, duration, max_repeat_count].hash
    end
