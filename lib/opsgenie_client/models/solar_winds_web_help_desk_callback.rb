...
module OpsgenieClient
  ...
  class SolarWindsWebHelpDeskCallback
    ...
    def hash
      [alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, solar_winds_web_help_desk_api_key, solar_winds_web_help_server_url].hash
    end
