...
module OpsgenieClient
  ...
  class TimelinePeriod
    ...
    attr_accessor :flattened_recipients
    ...
    def self.swagger_types
      {
        ...
        :'flattened_recipients' => :'Array<TimelineRecipient>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'flattenedRecipients')
        if (value = attributes[:'flattenedRecipients']).is_a?(Array)
          self.flattened_recipients = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flattened_recipients == o.flattened_recipients
    end
    ...
    def hash
      [start_date, end_date, type, from_user, recipient, flattened_recipients].hash
    end
