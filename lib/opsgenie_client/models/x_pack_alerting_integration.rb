...
module OpsgenieClient
  ...
  class XPackAlertingIntegration
    ...
    attr_accessor :eswatcher_action_id

    attr_accessor :eswatcher_host_id
    ...
    def self.swagger_types
      {
        ...
        :'eswatcher_action_id' => :'String',
        :'eswatcher_host_id' => :'String',
        :'type' => :'String',
        :'id' => :'String',
        :'name' => :'String',
        :'enabled' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'eswatcherActionId')
        self.eswatcher_action_id = attributes[:'eswatcherActionId']
      end

      if attributes.has_key?(:'eswatcherHostId')
        self.eswatcher_host_id = attributes[:'eswatcherHostId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          eswatcher_action_id == o.eswatcher_action_id &&
          eswatcher_host_id == o.eswatcher_host_id &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, eswatcher_action_id, eswatcher_host_id, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
