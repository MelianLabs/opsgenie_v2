...
module OpsgenieClient
  ...
  class KayakoCallback
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, email, password, subdomain].hash
    end
