...
module OpsgenieClient
  ...
  class EscalationRule
    ...
    def valid?
      ...
      condition_validator = EnumAttributeValidator.new('String', ["if-not-acked", "if-not-closed"])
      return false unless condition_validator.valid?(@condition)
      return false if @notify_type.nil?
      notify_type_validator = EnumAttributeValidator.new('String', ["default", "next", "previous", "users", "admins", "all"])
    ...
    def condition=(condition)
      validator = EnumAttributeValidator.new('String', ["if-not-acked", "if-not-closed"])
    ...
    def notify_type=(notify_type)
      validator = EnumAttributeValidator.new('String', ["default", "next", "previous", "users", "admins", "all"])
    ...
    def hash
      [condition, notify_type, delay, recipient].hash
    end
