...
module OpsgenieClient
  ...
  class CreateTeamRoutingRulePayload
    ...
    # Order of team routing rule within the rules. order value is actually the index of the team routing rule.
    attr_accessor :order
    ...
    def list_invalid_properties
      ...
      if @notify.nil?
        invalid_properties.push("invalid value for 'notify', notify cannot be nil.")
      end
    ...
    def hash
      [name, order, criteria, time_restriction, notify, timezone].hash
    end
