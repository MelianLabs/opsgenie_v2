...
module OpsgenieClient
  ...
  class DeskIntegration
    ...
    attr_accessor :consumer_key_secret
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'consumerKeySecret')
        self.consumer_key_secret = attributes[:'consumerKeySecret']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          consumer_key_secret == o.consumer_key_secret &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, consumer_key, consumer_key_secret, access_token, access_token_secret, subdomain, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
