...
module OpsgenieClient
  ...
  class StatusPageIOIntegration
    ...
    attr_accessor :status_page_page_id

    attr_accessor :status_page_api_key
    ...
    def self.swagger_types
      {
        ...
        :'status_page_page_id' => :'String',
        :'status_page_api_key' => :'String',
        :'type' => :'String',
        :'id' => :'String',
        :'name' => :'String',
        :'enabled' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'statusPagePageId')
        self.status_page_page_id = attributes[:'statusPagePageId']
      end

      if attributes.has_key?(:'statusPageApiKey')
        self.status_page_api_key = attributes[:'statusPageApiKey']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status_page_page_id == o.status_page_page_id &&
          status_page_api_key == o.status_page_api_key &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, status_page_page_id, status_page_api_key, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
