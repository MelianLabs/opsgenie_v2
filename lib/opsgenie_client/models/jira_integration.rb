...
module OpsgenieClient
  ...
  class JiraIntegration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'jiraUsername')
        self.jira_username = attributes[:'jiraUsername']
      end

      if attributes.has_key?(:'jiraPassword')
        self.jira_password = attributes[:'jiraPassword']
      end

      if attributes.has_key?(:'jiraUrl')
        self.jira_url = attributes[:'jiraUrl']
      end
      ...
      if attributes.has_key?(:'issueTypeName')
        self.issue_type_name = attributes[:'issueTypeName']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          jira_username == o.jira_username &&
          jira_password == o.jira_password &&
          jira_url == o.jira_url &&
          project_key == o.project_key &&
          issue_type_name == o.issue_type_name &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, jira_username, jira_password, jira_url, project_key, issue_type_name, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
