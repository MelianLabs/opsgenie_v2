...
module OpsgenieClient
  ...
  class UpdateUserPayload
    ...
    attr_accessor :invitation_disabled
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invitationDisabled')
        self.invitation_disabled = attributes[:'invitationDisabled']
      end
    ...
    def list_invalid_properties
      ...
      if !@username.nil? && @username.to_s.length > 100
        invalid_properties.push("invalid value for 'username', the character length must be smaller than or equal to 100.")
      end

      if !@full_name.nil? && @full_name.to_s.length > 512
        invalid_properties.push("invalid value for 'full_name', the character length must be smaller than or equal to 512.")
      end
    ...
    def valid?
      return false if !@username.nil? && @username.to_s.length > 100
      return false if !@full_name.nil? && @full_name.to_s.length > 512
      return true
    end
    ...
    def full_name=(full_name)
      ...
      if !full_name.nil? && full_name.to_s.length > 512
        fail ArgumentError, "invalid value for 'full_name', the character length must be smaller than or equal to 512."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tags == o.tags &&
          details == o.details &&
          invitation_disabled == o.invitation_disabled
    end
    ...
    def hash
      [username, full_name, role, skype_username, time_zone, locale, user_address, tags, details, invitation_disabled].hash
    end
