...
module OpsgenieClient
  ...
  class OpsgenieCallback
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, destination_api_key, api_key].hash
    end
