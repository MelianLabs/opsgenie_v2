...
module OpsgenieClient
  ...
  class SolarWindsWebHelpDeskIntegration
    ...
    attr_accessor :solar_winds_web_help_desk_api_key

    attr_accessor :solar_winds_web_help_server_url
    ...
    def self.swagger_types
      {
        ...
        :'solar_winds_web_help_desk_api_key' => :'String',
        :'solar_winds_web_help_server_url' => :'String',
        :'type' => :'String',
        :'id' => :'String',
        :'name' => :'String',
        :'enabled' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'solarWindsWebHelpDeskApiKey')
        self.solar_winds_web_help_desk_api_key = attributes[:'solarWindsWebHelpDeskApiKey']
      end

      if attributes.has_key?(:'solarWindsWebHelpServerURL')
        self.solar_winds_web_help_server_url = attributes[:'solarWindsWebHelpServerURL']
      end
    ...
    def valid?
      ...
      bidirectional_callback_type_validator = EnumAttributeValidator.new('String', ["datadog-callback", "circonus-callback", "connect-wise-callback", "desk-callback", "es-watcher-callback", "freshdesk-callback", "hipchat-callback", "marid-callback", "logic-monitor-callback", "mattermost-callback", "slack-callback", "solarwinds-web-helpdesk-callback", "stackdriver-callback", "status-io-callback"])
    ...
    def bidirectional_callback_type=(bidirectional_callback_type)
      validator = EnumAttributeValidator.new('String', ["datadog-callback", "circonus-callback", "connect-wise-callback", "desk-callback", "es-watcher-callback", "freshdesk-callback", "hipchat-callback", "marid-callback", "logic-monitor-callback", "mattermost-callback", "slack-callback", "solarwinds-web-helpdesk-callback", "stackdriver-callback", "status-io-callback"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          solar_winds_web_help_desk_api_key == o.solar_winds_web_help_desk_api_key &&
          solar_winds_web_help_server_url == o.solar_winds_web_help_server_url &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, solar_winds_web_help_desk_api_key, solar_winds_web_help_server_url, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
