...
module OpsgenieClient
  ...
  class StatusIOIntegration
    ...
    attr_accessor :status_io_api_id

    attr_accessor :status_io_api_key

    attr_accessor :status_io_status_page_id
    ...
    def self.swagger_types
      {
        ...
        :'status_io_api_id' => :'String',
        :'status_io_api_key' => :'String',
        :'status_io_status_page_id' => :'String',
        :'type' => :'String',
        :'id' => :'String',
        :'name' => :'String',
        :'enabled' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'statusIoApiId')
        self.status_io_api_id = attributes[:'statusIoApiId']
      end

      if attributes.has_key?(:'statusIoApiKey')
        self.status_io_api_key = attributes[:'statusIoApiKey']
      end

      if attributes.has_key?(:'statusIoStatusPageId')
        self.status_io_status_page_id = attributes[:'statusIoStatusPageId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status_io_api_id == o.status_io_api_id &&
          status_io_api_key == o.status_io_api_key &&
          status_io_status_page_id == o.status_io_status_page_id &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, status_io_api_id, status_io_api_key, status_io_status_page_id, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
