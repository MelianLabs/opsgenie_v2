...
module OpsgenieClient
  ...
  class XPackAlertingCallback
    ...
    def hash
      [alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, eswatcher_action_id, eswatcher_host_id].hash
    end
