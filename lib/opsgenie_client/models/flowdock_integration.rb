...
module OpsgenieClient
  ...
  class FlowdockIntegration
    ...
    attr_accessor :flowdock_api_token

    attr_accessor :flowdock_tags
    ...
    def self.swagger_types
      {
        ...
        :'flowdock_tags' => :'Hash<String, String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'flowdockApiToken')
        self.flowdock_api_token = attributes[:'flowdockApiToken']
      end

      if attributes.has_key?(:'flowdockTags')
        if (value = attributes[:'flowdockTags']).is_a?(Hash)
          self.flowdock_tags = value
        end
      end

      if attributes.has_key?(:'externalUsername')
        self.external_username = attributes[:'externalUsername']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flowdock_api_token == o.flowdock_api_token &&
          flowdock_tags == o.flowdock_tags &&
    ...
    def hash
      [alert_filter, alert_actions, callback_type, flowdock_api_token, flowdock_tags, external_username, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
