...
module OpsgenieClient
  ...
  class DeprecatedAutoCloseAlertPolicy
    attr_accessor :id
    ...
    # Duration to wait before closing the alert
    ...
    def hash
      [id, name, policy_description, filter, time_restrictions, enabled, type, duration].hash
    end
