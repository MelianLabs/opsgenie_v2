...
module OpsgenieClient
  ...
  class CreateSchedulePayload
    ...
    # Owner team of the schedule, consisting id and/or name of the owner team
    ...
    def self.swagger_types
      {
        ...
        :'enabled' => :'BOOLEAN',
        :'owner_team' => :'TeamMeta',
        :'rotations' => :'Array<CreateScheduleRotationPayload>'
      }
    end
    ...
    def hash
      [name, description, timezone, enabled, owner_team, rotations].hash
    end
