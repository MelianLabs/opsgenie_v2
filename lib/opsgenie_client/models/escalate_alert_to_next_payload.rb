...
module OpsgenieClient
  ...
  class EscalateAlertToNextPayload
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'escalation')
        self.escalation = attributes[:'escalation']
      end
    ...
    def list_invalid_properties
      ...
      if @escalation.nil?
        invalid_properties.push("invalid value for 'escalation', escalation cannot be nil.")
      end
    ...
    def valid?
      return false if @escalation.nil?
      return true
    end
    ...
    def hash
      [user, note, source, escalation].hash
    end
