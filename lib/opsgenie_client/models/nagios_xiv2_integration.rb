...
module OpsgenieClient
  ...
  class NagiosXIV2Integration
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
