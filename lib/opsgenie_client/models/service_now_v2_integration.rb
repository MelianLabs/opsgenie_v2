...
module OpsgenieClient
  ...
  class ServiceNowV2Integration
    ...
    attr_accessor :scripted_rest_apiurl

    attr_accessor :servicenow_user_name

    attr_accessor :servicenow_password
    ...
    def self.swagger_types
      {
        ...
        :'scripted_rest_apiurl' => :'String',
        :'servicenow_user_name' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'scriptedRestAPIURL')
        self.scripted_rest_apiurl = attributes[:'scriptedRestAPIURL']
      end

      if attributes.has_key?(:'servicenowUserName')
        self.servicenow_user_name = attributes[:'servicenowUserName']
      end

      if attributes.has_key?(:'servicenowPassword')
        self.servicenow_password = attributes[:'servicenowPassword']
      end
    ...
    def valid?
      ...
      callback_type_validator = EnumAttributeValidator.new('String', ["bidirectional-callback-new", "amazon-sns-callback"])
      return false unless callback_type_validator.valid?(@callback_type)
      bidirectional_callback_type_validator = EnumAttributeValidator.new('String', ["opsgenie-callback", "jira-callback", "jira-service-desk-callback", "service-now-callback", "kayako-callback", "ms-teams-callback", "op5-callback", "status-page-io-callback", "zendesk-callback"])
    ...
    def callback_type=(callback_type)
      validator = EnumAttributeValidator.new('String', ["bidirectional-callback-new", "amazon-sns-callback"])
    ...
    def bidirectional_callback_type=(bidirectional_callback_type)
      validator = EnumAttributeValidator.new('String', ["opsgenie-callback", "jira-callback", "jira-service-desk-callback", "service-now-callback", "kayako-callback", "ms-teams-callback", "op5-callback", "status-page-io-callback", "zendesk-callback"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scripted_rest_apiurl == o.scripted_rest_apiurl &&
          servicenow_user_name == o.servicenow_user_name &&
          servicenow_password == o.servicenow_password &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, scripted_rest_apiurl, servicenow_user_name, servicenow_password, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
