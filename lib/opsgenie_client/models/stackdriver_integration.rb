...
module OpsgenieClient
  ...
  class StackdriverIntegration
    ...
    attr_accessor :stackdriver_api_key
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stackdriverApiKey')
        self.stackdriver_api_key = attributes[:'stackdriverApiKey']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          stackdriver_api_key == o.stackdriver_api_key &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, stackdriver_api_key, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
