...
module OpsgenieClient
  ...
  class ZendeskIntegration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'zendeskApiToken')
        self.zendesk_api_token = attributes[:'zendeskApiToken']
      end

      if attributes.has_key?(:'zendeskEmail')
        self.zendesk_email = attributes[:'zendeskEmail']
      end

      if attributes.has_key?(:'zendeskSubdomain')
        self.zendesk_subdomain = attributes[:'zendeskSubdomain']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          zendesk_api_token == o.zendesk_api_token &&
          zendesk_email == o.zendesk_email &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, zendesk_api_token, zendesk_email, zendesk_subdomain, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
