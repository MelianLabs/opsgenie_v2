...
module OpsgenieClient
  ...
  class FlowdockV2Integration
    ...
    attr_accessor :flowdock_flow_token
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'flowdockFlowToken')
        self.flowdock_flow_token = attributes[:'flowdockFlowToken']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flowdock_flow_token == o.flowdock_flow_token &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [alert_filter, alert_actions, callback_type, flowdock_flow_token, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
