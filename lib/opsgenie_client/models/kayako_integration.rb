...
module OpsgenieClient
  ...
  class KayakoIntegration
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, email, password, subdomain, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
