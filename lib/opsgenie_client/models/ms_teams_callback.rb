...
module OpsgenieClient
  ...
  class MSTeamsCallback
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, webhook_url].hash
    end
