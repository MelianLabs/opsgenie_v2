...
module OpsgenieClient
  ...
  class StatusPageIOCallback
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, status_page_page_id, status_page_api_key].hash
    end
