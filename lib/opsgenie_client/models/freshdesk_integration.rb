...
module OpsgenieClient
  ...
  class FreshdeskIntegration
    ...
    attr_accessor :freshdesk_api_key

    attr_accessor :freshdesk_subdomain
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'freshdeskApiKey')
        self.freshdesk_api_key = attributes[:'freshdeskApiKey']
      end

      if attributes.has_key?(:'freshdeskSubdomain')
        self.freshdesk_subdomain = attributes[:'freshdeskSubdomain']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          freshdesk_api_key == o.freshdesk_api_key &&
          freshdesk_subdomain == o.freshdesk_subdomain &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, feature_type, allow_configuration_access, allow_write_access, alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, freshdesk_api_key, freshdesk_subdomain, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
