...
module OpsgenieClient
  ...
  class CreateSavedSearchPayload
    ...
    def list_invalid_properties
      ...
      if @query.to_s.length > 1000
        invalid_properties.push("invalid value for 'query', the character length must be smaller than or equal to 1000.")
      end
    ...
    def valid?
      ...
      return false if @query.to_s.length > 1000
    ...
    def query=(query)
      ...
      if query.to_s.length > 1000
        fail ArgumentError, "invalid value for 'query', the character length must be smaller than or equal to 1000."
      end
    ...
    def hash
      [name, description, query, owner, teams].hash
    end
