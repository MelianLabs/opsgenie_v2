...
module OpsgenieClient
  ...
  class JiraCallback
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, jira_username, jira_password, jira_url, project_key, issue_type_name].hash
    end
