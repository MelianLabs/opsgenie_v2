...
module OpsgenieClient
  ...
  class FreshdeskCallback
    ...
    def hash
      [alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, freshdesk_api_key, freshdesk_subdomain].hash
    end
