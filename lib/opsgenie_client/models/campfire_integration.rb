...
module OpsgenieClient
  ...
  class CampfireIntegration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'topicArn')
        self.topic_arn = attributes[:'topicArn']
      end
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, topic_arn, region, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
