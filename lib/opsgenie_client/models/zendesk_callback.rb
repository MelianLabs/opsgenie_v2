...
module OpsgenieClient
  ...
  class ZendeskCallback
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, zendesk_api_token, zendesk_email, zendesk_subdomain].hash
    end
