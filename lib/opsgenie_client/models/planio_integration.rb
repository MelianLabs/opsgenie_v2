...
module OpsgenieClient
  ...
  class PlanioIntegration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'planioApiKey')
        self.planio_api_key = attributes[:'planioApiKey']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          planio_api_key == o.planio_api_key &&
    ...
    def hash
      [alert_filter, alert_actions, callback_type, planio_api_key, project_id, subdomain, type, id, name, enabled, owner_team, is_global, _read_only].hash
    end
