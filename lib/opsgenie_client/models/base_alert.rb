...
module OpsgenieClient
  ...
  class BaseAlert
    ...
    def hash
      [id, tiny_id, _alias, message, status, acknowledged, is_seen, tags, snoozed, snoozed_until, count, last_occurred_at, created_at, updated_at, source, owner, priority, teams, responders, integration, report].hash
    end
