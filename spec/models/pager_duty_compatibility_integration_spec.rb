...
# Unit tests for OpsgenieClient::PagerDutyCompatibilityIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PagerDutyCompatibilityIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::PagerDutyCompatibilityIntegration.new
  end
  ...
  describe 'test an instance of PagerDutyCompatibilityIntegration' do
    it 'should create an instance of PagerDutyCompatibilityIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::PagerDutyCompatibilityIntegration)
    end
  end
