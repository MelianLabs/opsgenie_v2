...
# Unit tests for OpsgenieClient::ScalyrIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScalyrIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ScalyrIntegration.new
  end
  ...
  describe 'test an instance of ScalyrIntegration' do
    it 'should create an instance of ScalyrIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ScalyrIntegration)
    end
  end
