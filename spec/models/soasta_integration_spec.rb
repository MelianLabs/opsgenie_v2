...
# Unit tests for OpsgenieClient::SoastaIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SoastaIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SoastaIntegration.new
  end
  ...
  describe 'test an instance of SoastaIntegration' do
    it 'should create an instance of SoastaIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SoastaIntegration)
    end
  end
