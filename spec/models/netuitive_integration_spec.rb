...
# Unit tests for OpsgenieClient::NetuitiveIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NetuitiveIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::NetuitiveIntegration.new
  end
  ...
  describe 'test an instance of NetuitiveIntegration' do
    it 'should create an instance of NetuitiveIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::NetuitiveIntegration)
    end
  end
