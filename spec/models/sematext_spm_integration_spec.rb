...
# Unit tests for OpsgenieClient::SematextSpmIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SematextSpmIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SematextSpmIntegration.new
  end
  ...
  describe 'test an instance of SematextSpmIntegration' do
    it 'should create an instance of SematextSpmIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SematextSpmIntegration)
    end
  end
