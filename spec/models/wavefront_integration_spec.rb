...
# Unit tests for OpsgenieClient::WavefrontIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WavefrontIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::WavefrontIntegration.new
  end
  ...
  describe 'test an instance of WavefrontIntegration' do
    it 'should create an instance of WavefrontIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::WavefrontIntegration)
    end
  end
