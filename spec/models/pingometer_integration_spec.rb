...
# Unit tests for OpsgenieClient::PingometerIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PingometerIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::PingometerIntegration.new
  end
  ...
  describe 'test an instance of PingometerIntegration' do
    it 'should create an instance of PingometerIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::PingometerIntegration)
    end
  end
