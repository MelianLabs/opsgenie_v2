...
# Unit tests for OpsgenieClient::CircleCiIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CircleCiIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CircleCiIntegration.new
  end
  ...
  describe 'test an instance of CircleCiIntegration' do
    it 'should create an instance of CircleCiIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CircleCiIntegration)
    end
  end
