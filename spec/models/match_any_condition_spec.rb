...
# Unit tests for OpsgenieClient::MatchAnyCondition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MatchAnyCondition' do
  before do
    # run before each test
    @instance = OpsgenieClient::MatchAnyCondition.new
  end
  ...
  describe 'test an instance of MatchAnyCondition' do
    it 'should create an instance of MatchAnyCondition' do
      expect(@instance).to be_instance_of(OpsgenieClient::MatchAnyCondition)
    end
  end
