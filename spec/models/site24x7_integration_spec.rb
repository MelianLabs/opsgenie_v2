...
# Unit tests for OpsgenieClient::Site24x7Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Site24x7Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::Site24x7Integration.new
  end
  ...
  describe 'test an instance of Site24x7Integration' do
    it 'should create an instance of Site24x7Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::Site24x7Integration)
    end
  end
