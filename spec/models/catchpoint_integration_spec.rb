...
# Unit tests for OpsgenieClient::CatchpointIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CatchpointIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CatchpointIntegration.new
  end
  ...
  describe 'test an instance of CatchpointIntegration' do
    it 'should create an instance of CatchpointIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CatchpointIntegration)
    end
  end
