...
# Unit tests for OpsgenieClient::MongoDBCloudIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MongoDBCloudIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::MongoDBCloudIntegration.new
  end
  ...
  describe 'test an instance of MongoDBCloudIntegration' do
    it 'should create an instance of MongoDBCloudIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::MongoDBCloudIntegration)
    end
  end
