...
# Unit tests for OpsgenieClient::Op5Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Op5Callback' do
  before do
    # run before each test
    @instance = OpsgenieClient::Op5Callback.new
  end
  ...
  describe 'test an instance of Op5Callback' do
    it 'should create an instance of Op5Callback' do
      expect(@instance).to be_instance_of(OpsgenieClient::Op5Callback)
    end
  end
