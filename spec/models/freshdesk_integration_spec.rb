...
# Unit tests for OpsgenieClient::FreshdeskIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FreshdeskIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::FreshdeskIntegration.new
  end
  ...
  describe 'test an instance of FreshdeskIntegration' do
    it 'should create an instance of FreshdeskIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::FreshdeskIntegration)
    end
  end
  ...
  describe 'test attribute "freshdesk_api_key"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "freshdesk_subdomain"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
