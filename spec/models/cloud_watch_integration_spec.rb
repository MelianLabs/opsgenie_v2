...
# Unit tests for OpsgenieClient::CloudWatchIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CloudWatchIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CloudWatchIntegration.new
  end
  ...
  describe 'test an instance of CloudWatchIntegration' do
    it 'should create an instance of CloudWatchIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CloudWatchIntegration)
    end
  end
