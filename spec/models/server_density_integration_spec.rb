...
# Unit tests for OpsgenieClient::ServerDensityIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServerDensityIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ServerDensityIntegration.new
  end
  ...
  describe 'test an instance of ServerDensityIntegration' do
    it 'should create an instance of ServerDensityIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ServerDensityIntegration)
    end
  end
