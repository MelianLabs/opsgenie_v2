...
# Unit tests for OpsgenieClient::TwilioCIIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TwilioCIIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::TwilioCIIntegration.new
  end
  ...
  describe 'test an instance of TwilioCIIntegration' do
    it 'should create an instance of TwilioCIIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::TwilioCIIntegration)
    end
  end
