...
# Unit tests for OpsgenieClient::SignalfxIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignalfxIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SignalfxIntegration.new
  end
  ...
  describe 'test an instance of SignalfxIntegration' do
    it 'should create an instance of SignalfxIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SignalfxIntegration)
    end
  end
