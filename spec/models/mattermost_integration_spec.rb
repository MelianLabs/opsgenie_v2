...
# Unit tests for OpsgenieClient::MattermostIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MattermostIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::MattermostIntegration.new
  end
  ...
  describe 'test an instance of MattermostIntegration' do
    it 'should create an instance of MattermostIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::MattermostIntegration)
    end
  end
