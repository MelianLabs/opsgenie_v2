...
# Unit tests for OpsgenieClient::StruxureWareIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StruxureWareIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::StruxureWareIntegration.new
  end
  ...
  describe 'test an instance of StruxureWareIntegration' do
    it 'should create an instance of StruxureWareIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::StruxureWareIntegration)
    end
  end
