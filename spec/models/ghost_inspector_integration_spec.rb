...
# Unit tests for OpsgenieClient::GhostInspectorIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GhostInspectorIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::GhostInspectorIntegration.new
  end
  ...
  describe 'test an instance of GhostInspectorIntegration' do
    it 'should create an instance of GhostInspectorIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::GhostInspectorIntegration)
    end
  end
