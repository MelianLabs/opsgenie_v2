...
# Unit tests for OpsgenieClient::MSTeamsCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MSTeamsCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::MSTeamsCallback.new
  end
  ...
  describe 'test an instance of MSTeamsCallback' do
    it 'should create an instance of MSTeamsCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::MSTeamsCallback)
    end
  end
