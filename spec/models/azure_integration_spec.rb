...
# Unit tests for OpsgenieClient::AzureIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AzureIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AzureIntegration.new
  end
  ...
  describe 'test an instance of AzureIntegration' do
    it 'should create an instance of AzureIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AzureIntegration)
    end
  end
