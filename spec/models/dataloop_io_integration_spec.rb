...
# Unit tests for OpsgenieClient::DataloopIOIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DataloopIOIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::DataloopIOIntegration.new
  end
  ...
  describe 'test an instance of DataloopIOIntegration' do
    it 'should create an instance of DataloopIOIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::DataloopIOIntegration)
    end
  end
