...
# Unit tests for OpsgenieClient::AirbrakeIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AirbrakeIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AirbrakeIntegration.new
  end
  ...
  describe 'test an instance of AirbrakeIntegration' do
    it 'should create an instance of AirbrakeIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AirbrakeIntegration)
    end
  end
