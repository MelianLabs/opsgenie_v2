...
# Unit tests for OpsgenieClient::EmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::EmailIntegration.new
  end
  ...
  describe 'test an instance of EmailIntegration' do
    it 'should create an instance of EmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::EmailIntegration)
    end
  end
