...
# Unit tests for OpsgenieClient::SCOMIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SCOMIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SCOMIntegration.new
  end
  ...
  describe 'test an instance of SCOMIntegration' do
    it 'should create an instance of SCOMIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SCOMIntegration)
    end
  end
