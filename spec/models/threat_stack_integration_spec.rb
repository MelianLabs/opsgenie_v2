...
# Unit tests for OpsgenieClient::ThreatStackIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ThreatStackIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ThreatStackIntegration.new
  end
  ...
  describe 'test an instance of ThreatStackIntegration' do
    it 'should create an instance of ThreatStackIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ThreatStackIntegration)
    end
  end
