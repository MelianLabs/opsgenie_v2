...
# Unit tests for OpsgenieClient::CodeshipIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CodeshipIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CodeshipIntegration.new
  end
  ...
  describe 'test an instance of CodeshipIntegration' do
    it 'should create an instance of CodeshipIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CodeshipIntegration)
    end
  end
