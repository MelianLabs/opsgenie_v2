...
# Unit tests for OpsgenieClient::DripStatIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DripStatIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::DripStatIntegration.new
  end
  ...
  describe 'test an instance of DripStatIntegration' do
    it 'should create an instance of DripStatIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::DripStatIntegration)
    end
  end
