...
# Unit tests for OpsgenieClient::FreshserviceIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FreshserviceIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::FreshserviceIntegration.new
  end
  ...
  describe 'test an instance of FreshserviceIntegration' do
    it 'should create an instance of FreshserviceIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::FreshserviceIntegration)
    end
  end
