...
# Unit tests for OpsgenieClient::ConnectWiseIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectWiseIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ConnectWiseIntegration.new
  end
  ...
  describe 'test an instance of ConnectWiseIntegration' do
    it 'should create an instance of ConnectWiseIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ConnectWiseIntegration)
    end
  end
  ...
  describe 'test attribute "aws_lambda_url"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
