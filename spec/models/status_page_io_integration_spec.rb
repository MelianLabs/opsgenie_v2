...
# Unit tests for OpsgenieClient::StatusPageIOIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusPageIOIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::StatusPageIOIntegration.new
  end
  ...
  describe 'test an instance of StatusPageIOIntegration' do
    it 'should create an instance of StatusPageIOIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::StatusPageIOIntegration)
    end
  end
  ...
  describe 'test attribute "status_page_page_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "status_page_api_key"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
