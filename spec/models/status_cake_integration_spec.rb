...
# Unit tests for OpsgenieClient::StatusCakeIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusCakeIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::StatusCakeIntegration.new
  end
  ...
  describe 'test an instance of StatusCakeIntegration' do
    it 'should create an instance of StatusCakeIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::StatusCakeIntegration)
    end
  end
