...
# Unit tests for OpsgenieClient::LogzIOIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LogzIOIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::LogzIOIntegration.new
  end
  ...
  describe 'test an instance of LogzIOIntegration' do
    it 'should create an instance of LogzIOIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::LogzIOIntegration)
    end
  end
