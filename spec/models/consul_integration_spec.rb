...
# Unit tests for OpsgenieClient::ConsulIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConsulIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ConsulIntegration.new
  end
  ...
  describe 'test an instance of ConsulIntegration' do
    it 'should create an instance of ConsulIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ConsulIntegration)
    end
  end
