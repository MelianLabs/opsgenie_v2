...
# Unit tests for OpsgenieClient::ConnectWiseCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectWiseCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::ConnectWiseCallback.new
  end
  ...
  describe 'test an instance of ConnectWiseCallback' do
    it 'should create an instance of ConnectWiseCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::ConnectWiseCallback)
    end
  end
