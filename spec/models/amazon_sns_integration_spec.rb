...
# Unit tests for OpsgenieClient::AmazonSnsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonSnsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AmazonSnsIntegration.new
  end
  ...
  describe 'test an instance of AmazonSnsIntegration' do
    it 'should create an instance of AmazonSnsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AmazonSnsIntegration)
    end
  end
