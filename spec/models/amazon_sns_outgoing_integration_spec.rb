...
# Unit tests for OpsgenieClient::AmazonSnsOutgoingIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonSnsOutgoingIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AmazonSnsOutgoingIntegration.new
  end
  ...
  describe 'test an instance of AmazonSnsOutgoingIntegration' do
    it 'should create an instance of AmazonSnsOutgoingIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AmazonSnsOutgoingIntegration)
    end
  end
