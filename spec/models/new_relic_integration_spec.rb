...
# Unit tests for OpsgenieClient::NewRelicIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewRelicIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::NewRelicIntegration.new
  end
  ...
  describe 'test an instance of NewRelicIntegration' do
    it 'should create an instance of NewRelicIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::NewRelicIntegration)
    end
  end
