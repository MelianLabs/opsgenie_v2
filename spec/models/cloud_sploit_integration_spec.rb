...
# Unit tests for OpsgenieClient::CloudSploitIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CloudSploitIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CloudSploitIntegration.new
  end
  ...
  describe 'test an instance of CloudSploitIntegration' do
    it 'should create an instance of CloudSploitIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CloudSploitIntegration)
    end
  end
