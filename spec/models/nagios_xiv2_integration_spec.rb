...
# Unit tests for OpsgenieClient::NagiosXIV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosXIV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::NagiosXIV2Integration.new
  end
  ...
  describe 'test an instance of NagiosXIV2Integration' do
    it 'should create an instance of NagiosXIV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::NagiosXIV2Integration)
    end
  end
