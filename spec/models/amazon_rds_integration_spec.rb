...
# Unit tests for OpsgenieClient::AmazonRdsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonRdsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AmazonRdsIntegration.new
  end
  ...
  describe 'test an instance of AmazonRdsIntegration' do
    it 'should create an instance of AmazonRdsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AmazonRdsIntegration)
    end
  end
