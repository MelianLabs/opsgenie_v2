...
# Unit tests for OpsgenieClient::CampfireIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CampfireIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CampfireIntegration.new
  end
  ...
  describe 'test an instance of CampfireIntegration' do
    it 'should create an instance of CampfireIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CampfireIntegration)
    end
  end
