...
# Unit tests for OpsgenieClient::SolarwindsMSPNCentralIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolarwindsMSPNCentralIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SolarwindsMSPNCentralIntegration.new
  end
  ...
  describe 'test an instance of SolarwindsMSPNCentralIntegration' do
    it 'should create an instance of SolarwindsMSPNCentralIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SolarwindsMSPNCentralIntegration)
    end
  end
