...
# Unit tests for OpsgenieClient::WebhookIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::WebhookIntegration.new
  end
  ...
  describe 'test an instance of WebhookIntegration' do
    it 'should create an instance of WebhookIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::WebhookIntegration)
    end
  end
