...
# Unit tests for OpsgenieClient::NodePingIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NodePingIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::NodePingIntegration.new
  end
  ...
  describe 'test an instance of NodePingIntegration' do
    it 'should create an instance of NodePingIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::NodePingIntegration)
    end
  end
