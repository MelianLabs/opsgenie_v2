...
# Unit tests for OpsgenieClient::LogentriesIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LogentriesIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::LogentriesIntegration.new
  end
  ...
  describe 'test an instance of LogentriesIntegration' do
    it 'should create an instance of LogentriesIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::LogentriesIntegration)
    end
  end
