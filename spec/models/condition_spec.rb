...
# Unit tests for OpsgenieClient::Condition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Condition' do
  before do
    # run before each test
    @instance = OpsgenieClient::Condition.new
  end
  ...
  describe 'test an instance of Condition' do
    it 'should create an instance of Condition' do
      expect(@instance).to be_instance_of(OpsgenieClient::Condition)
    end
  end
  describe 'test attribute "field"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["message", "alias", "description", "source", "entity", "tags", "actions", "extra-properties", "recipients", "teams", "priority", "details"])
