...
# Unit tests for OpsgenieClient::AmazonSesIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonSesIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AmazonSesIntegration.new
  end
  ...
  describe 'test an instance of AmazonSesIntegration' do
    it 'should create an instance of AmazonSesIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AmazonSesIntegration)
    end
  end
