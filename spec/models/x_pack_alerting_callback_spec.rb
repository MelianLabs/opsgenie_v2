...
# Unit tests for OpsgenieClient::XPackAlertingCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XPackAlertingCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::XPackAlertingCallback.new
  end
  ...
  describe 'test an instance of XPackAlertingCallback' do
    it 'should create an instance of XPackAlertingCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::XPackAlertingCallback)
    end
  end
