...
# Unit tests for OpsgenieClient::OpsDashIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OpsDashIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::OpsDashIntegration.new
  end
  ...
  describe 'test an instance of OpsDashIntegration' do
    it 'should create an instance of OpsDashIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::OpsDashIntegration)
    end
  end
