...
# Unit tests for OpsgenieClient::Op5Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Op5Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::Op5Integration.new
  end
  ...
  describe 'test an instance of Op5Integration' do
    it 'should create an instance of Op5Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::Op5Integration)
    end
  end
