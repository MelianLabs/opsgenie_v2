...
# Unit tests for OpsgenieClient::BaseIncomingFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseIncomingFeature' do
  before do
    # run before each test
    @instance = OpsgenieClient::BaseIncomingFeature.new
  end
  ...
  describe 'test an instance of BaseIncomingFeature' do
    it 'should create an instance of BaseIncomingFeature' do
      expect(@instance).to be_instance_of(OpsgenieClient::BaseIncomingFeature)
    end
  end
