...
# Unit tests for OpsgenieClient::ServerGuard24Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServerGuard24Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ServerGuard24Integration.new
  end
  ...
  describe 'test an instance of ServerGuard24Integration' do
    it 'should create an instance of ServerGuard24Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ServerGuard24Integration)
    end
  end
