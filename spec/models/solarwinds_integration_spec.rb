...
# Unit tests for OpsgenieClient::SolarwindsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolarwindsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SolarwindsIntegration.new
  end
  ...
  describe 'test an instance of SolarwindsIntegration' do
    it 'should create an instance of SolarwindsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SolarwindsIntegration)
    end
  end
