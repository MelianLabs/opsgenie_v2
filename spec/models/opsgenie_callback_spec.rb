...
# Unit tests for OpsgenieClient::OpsgenieCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OpsgenieCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::OpsgenieCallback.new
  end
  ...
  describe 'test an instance of OpsgenieCallback' do
    it 'should create an instance of OpsgenieCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::OpsgenieCallback)
    end
  end
