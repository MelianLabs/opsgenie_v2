...
# Unit tests for OpsgenieClient::RedGateSqlMonitorEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RedGateSqlMonitorEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::RedGateSqlMonitorEmailIntegration.new
  end
  ...
  describe 'test an instance of RedGateSqlMonitorEmailIntegration' do
    it 'should create an instance of RedGateSqlMonitorEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::RedGateSqlMonitorEmailIntegration)
    end
  end
