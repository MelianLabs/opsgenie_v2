...
# Unit tests for OpsgenieClient::SensuIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SensuIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SensuIntegration.new
  end
  ...
  describe 'test an instance of SensuIntegration' do
    it 'should create an instance of SensuIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SensuIntegration)
    end
  end
