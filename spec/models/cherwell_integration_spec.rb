...
# Unit tests for OpsgenieClient::CherwellIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CherwellIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CherwellIntegration.new
  end
  ...
  describe 'test an instance of CherwellIntegration' do
    it 'should create an instance of CherwellIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CherwellIntegration)
    end
  end
