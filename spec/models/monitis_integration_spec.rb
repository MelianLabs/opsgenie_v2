...
# Unit tests for OpsgenieClient::MonitisIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MonitisIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::MonitisIntegration.new
  end
  ...
  describe 'test an instance of MonitisIntegration' do
    it 'should create an instance of MonitisIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::MonitisIntegration)
    end
  end
