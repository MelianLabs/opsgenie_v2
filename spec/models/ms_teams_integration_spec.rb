...
# Unit tests for OpsgenieClient::MSTeamsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MSTeamsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::MSTeamsIntegration.new
  end
  ...
  describe 'test an instance of MSTeamsIntegration' do
    it 'should create an instance of MSTeamsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::MSTeamsIntegration)
    end
  end
