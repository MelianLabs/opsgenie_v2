...
# Unit tests for OpsgenieClient::DeskIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeskIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::DeskIntegration.new
  end
  ...
  describe 'test an instance of DeskIntegration' do
    it 'should create an instance of DeskIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::DeskIntegration)
    end
  end
  ...
  describe 'test attribute "consumer_key_secret"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
