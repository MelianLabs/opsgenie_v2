...
# Unit tests for OpsgenieClient::MaridIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MaridIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::MaridIntegration.new
  end
  ...
  describe 'test an instance of MaridIntegration' do
    it 'should create an instance of MaridIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::MaridIntegration)
    end
  end
