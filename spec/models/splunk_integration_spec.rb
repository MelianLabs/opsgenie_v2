...
# Unit tests for OpsgenieClient::SplunkIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SplunkIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SplunkIntegration.new
  end
  ...
  describe 'test an instance of SplunkIntegration' do
    it 'should create an instance of SplunkIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SplunkIntegration)
    end
  end
