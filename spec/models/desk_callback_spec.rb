...
# Unit tests for OpsgenieClient::DeskCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeskCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::DeskCallback.new
  end
  ...
  describe 'test an instance of DeskCallback' do
    it 'should create an instance of DeskCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::DeskCallback)
    end
  end
