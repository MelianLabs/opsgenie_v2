...
# Unit tests for OpsgenieClient::HostedGraphiteIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HostedGraphiteIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::HostedGraphiteIntegration.new
  end
  ...
  describe 'test an instance of HostedGraphiteIntegration' do
    it 'should create an instance of HostedGraphiteIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::HostedGraphiteIntegration)
    end
  end
