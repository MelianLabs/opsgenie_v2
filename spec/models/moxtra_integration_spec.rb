...
# Unit tests for OpsgenieClient::MoxtraIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoxtraIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::MoxtraIntegration.new
  end
  ...
  describe 'test an instance of MoxtraIntegration' do
    it 'should create an instance of MoxtraIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::MoxtraIntegration)
    end
  end
