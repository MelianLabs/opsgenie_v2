...
# Unit tests for OpsgenieClient::NewRelicV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewRelicV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::NewRelicV2Integration.new
  end
  ...
  describe 'test an instance of NewRelicV2Integration' do
    it 'should create an instance of NewRelicV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::NewRelicV2Integration)
    end
  end
