...
# Unit tests for OpsgenieClient::CampfireCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CampfireCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::CampfireCallback.new
  end
  ...
  describe 'test an instance of CampfireCallback' do
    it 'should create an instance of CampfireCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::CampfireCallback)
    end
  end
