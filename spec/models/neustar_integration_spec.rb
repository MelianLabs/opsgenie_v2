...
# Unit tests for OpsgenieClient::NeustarIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NeustarIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::NeustarIntegration.new
  end
  ...
  describe 'test an instance of NeustarIntegration' do
    it 'should create an instance of NeustarIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::NeustarIntegration)
    end
  end
