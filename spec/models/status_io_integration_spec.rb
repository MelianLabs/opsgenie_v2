...
# Unit tests for OpsgenieClient::StatusIOIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusIOIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::StatusIOIntegration.new
  end
  ...
  describe 'test an instance of StatusIOIntegration' do
    it 'should create an instance of StatusIOIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::StatusIOIntegration)
    end
  end
