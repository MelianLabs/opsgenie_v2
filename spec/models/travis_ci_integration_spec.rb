...
# Unit tests for OpsgenieClient::TravisCIIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravisCIIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::TravisCIIntegration.new
  end
  ...
  describe 'test an instance of TravisCIIntegration' do
    it 'should create an instance of TravisCIIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::TravisCIIntegration)
    end
  end
