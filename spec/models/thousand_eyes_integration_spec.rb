...
# Unit tests for OpsgenieClient::ThousandEyesIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ThousandEyesIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ThousandEyesIntegration.new
  end
  ...
  describe 'test an instance of ThousandEyesIntegration' do
    it 'should create an instance of ThousandEyesIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ThousandEyesIntegration)
    end
  end
