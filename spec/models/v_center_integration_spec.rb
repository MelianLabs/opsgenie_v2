...
# Unit tests for OpsgenieClient::VCenterIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VCenterIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::VCenterIntegration.new
  end
  ...
  describe 'test an instance of VCenterIntegration' do
    it 'should create an instance of VCenterIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::VCenterIntegration)
    end
  end
