...
# Unit tests for OpsgenieClient::DynatraceIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DynatraceIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::DynatraceIntegration.new
  end
  ...
  describe 'test an instance of DynatraceIntegration' do
    it 'should create an instance of DynatraceIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::DynatraceIntegration)
    end
  end
