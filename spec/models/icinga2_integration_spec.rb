...
# Unit tests for OpsgenieClient::Icinga2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Icinga2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::Icinga2Integration.new
  end
  ...
  describe 'test an instance of Icinga2Integration' do
    it 'should create an instance of Icinga2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::Icinga2Integration)
    end
  end
