...
# Unit tests for OpsgenieClient::BidirectionalCallbackNew
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BidirectionalCallbackNew' do
  before do
    # run before each test
    @instance = OpsgenieClient::BidirectionalCallbackNew.new
  end
  ...
  describe 'test an instance of BidirectionalCallbackNew' do
    it 'should create an instance of BidirectionalCallbackNew' do
      expect(@instance).to be_instance_of(OpsgenieClient::BidirectionalCallbackNew)
    end
  end
