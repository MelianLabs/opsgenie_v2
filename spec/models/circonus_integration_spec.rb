...
# Unit tests for OpsgenieClient::CirconusIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CirconusIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CirconusIntegration.new
  end
  ...
  describe 'test an instance of CirconusIntegration' do
    it 'should create an instance of CirconusIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CirconusIntegration)
    end
  end
  ...
  describe 'test attribute "circonus_url"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
