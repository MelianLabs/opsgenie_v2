...
# Unit tests for OpsgenieClient::FlowdockV2Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FlowdockV2Callback' do
  before do
    # run before each test
    @instance = OpsgenieClient::FlowdockV2Callback.new
  end
  ...
  describe 'test an instance of FlowdockV2Callback' do
    it 'should create an instance of FlowdockV2Callback' do
      expect(@instance).to be_instance_of(OpsgenieClient::FlowdockV2Callback)
    end
  end
