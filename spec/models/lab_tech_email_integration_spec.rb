...
# Unit tests for OpsgenieClient::LabTechEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabTechEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::LabTechEmailIntegration.new
  end
  ...
  describe 'test an instance of LabTechEmailIntegration' do
    it 'should create an instance of LabTechEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::LabTechEmailIntegration)
    end
  end
