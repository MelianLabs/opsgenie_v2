...
# Unit tests for OpsgenieClient::ZabbixIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZabbixIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ZabbixIntegration.new
  end
  ...
  describe 'test an instance of ZabbixIntegration' do
    it 'should create an instance of ZabbixIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ZabbixIntegration)
    end
  end
