...
# Unit tests for OpsgenieClient::PrtgIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrtgIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::PrtgIntegration.new
  end
  ...
  describe 'test an instance of PrtgIntegration' do
    it 'should create an instance of PrtgIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::PrtgIntegration)
    end
  end
