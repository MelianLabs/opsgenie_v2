...
# Unit tests for OpsgenieClient::RingCentralEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RingCentralEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::RingCentralEmailIntegration.new
  end
  ...
  describe 'test an instance of RingCentralEmailIntegration' do
    it 'should create an instance of RingCentralEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::RingCentralEmailIntegration)
    end
  end
