...
# Unit tests for OpsgenieClient::StatusPageIOCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusPageIOCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::StatusPageIOCallback.new
  end
  ...
  describe 'test an instance of StatusPageIOCallback' do
    it 'should create an instance of StatusPageIOCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::StatusPageIOCallback)
    end
  end
