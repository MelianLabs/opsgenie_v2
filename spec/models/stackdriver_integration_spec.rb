...
# Unit tests for OpsgenieClient::StackdriverIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StackdriverIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::StackdriverIntegration.new
  end
  ...
  describe 'test an instance of StackdriverIntegration' do
    it 'should create an instance of StackdriverIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::StackdriverIntegration)
    end
  end
  ...
  describe 'test attribute "stackdriver_api_key"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
