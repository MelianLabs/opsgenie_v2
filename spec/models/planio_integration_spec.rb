...
# Unit tests for OpsgenieClient::PlanioIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanioIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::PlanioIntegration.new
  end
  ...
  describe 'test an instance of PlanioIntegration' do
    it 'should create an instance of PlanioIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::PlanioIntegration)
    end
  end
