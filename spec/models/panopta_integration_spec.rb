...
# Unit tests for OpsgenieClient::PanoptaIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PanoptaIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::PanoptaIntegration.new
  end
  ...
  describe 'test an instance of PanoptaIntegration' do
    it 'should create an instance of PanoptaIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::PanoptaIntegration)
    end
  end
