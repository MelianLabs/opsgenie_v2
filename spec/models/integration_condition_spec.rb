...
# Unit tests for OpsgenieClient::IntegrationCondition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IntegrationCondition' do
  before do
    # run before each test
    @instance = OpsgenieClient::IntegrationCondition.new
  end
  ...
  describe 'test an instance of IntegrationCondition' do
    it 'should create an instance of IntegrationCondition' do
      expect(@instance).to be_instance_of(OpsgenieClient::IntegrationCondition)
    end
  end
