...
# Unit tests for OpsgenieClient::HoneybadgerIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HoneybadgerIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::HoneybadgerIntegration.new
  end
  ...
  describe 'test an instance of HoneybadgerIntegration' do
    it 'should create an instance of HoneybadgerIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::HoneybadgerIntegration)
    end
  end
