...
# Unit tests for OpsgenieClient::FlowdockIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FlowdockIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::FlowdockIntegration.new
  end
  ...
  describe 'test an instance of FlowdockIntegration' do
    it 'should create an instance of FlowdockIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::FlowdockIntegration)
    end
  end
