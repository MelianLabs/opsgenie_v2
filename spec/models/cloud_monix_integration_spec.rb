...
# Unit tests for OpsgenieClient::CloudMonixIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CloudMonixIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CloudMonixIntegration.new
  end
  ...
  describe 'test an instance of CloudMonixIntegration' do
    it 'should create an instance of CloudMonixIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CloudMonixIntegration)
    end
  end
