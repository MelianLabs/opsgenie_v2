...
# Unit tests for OpsgenieClient::OEMIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OEMIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::OEMIntegration.new
  end
  ...
  describe 'test an instance of OEMIntegration' do
    it 'should create an instance of OEMIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::OEMIntegration)
    end
  end
