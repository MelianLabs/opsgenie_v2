...
# Unit tests for OpsgenieClient::NagiosV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::NagiosV2Integration.new
  end
  ...
  describe 'test an instance of NagiosV2Integration' do
    it 'should create an instance of NagiosV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::NagiosV2Integration)
    end
  end
