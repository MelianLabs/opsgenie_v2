...
# Unit tests for OpsgenieClient::RiemannIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RiemannIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::RiemannIntegration.new
  end
  ...
  describe 'test an instance of RiemannIntegration' do
    it 'should create an instance of RiemannIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::RiemannIntegration)
    end
  end
