...
# Unit tests for OpsgenieClient::SumoLogicIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SumoLogicIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SumoLogicIntegration.new
  end
  ...
  describe 'test an instance of SumoLogicIntegration' do
    it 'should create an instance of SumoLogicIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SumoLogicIntegration)
    end
  end
