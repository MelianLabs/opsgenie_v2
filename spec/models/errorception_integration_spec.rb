...
# Unit tests for OpsgenieClient::ErrorceptionIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorceptionIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ErrorceptionIntegration.new
  end
  ...
  describe 'test an instance of ErrorceptionIntegration' do
    it 'should create an instance of ErrorceptionIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ErrorceptionIntegration)
    end
  end
