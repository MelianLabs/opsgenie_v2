...
# Unit tests for OpsgenieClient::ServiceNowV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceNowV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ServiceNowV2Integration.new
  end
  ...
  describe 'test an instance of ServiceNowV2Integration' do
    it 'should create an instance of ServiceNowV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ServiceNowV2Integration)
    end
  end
