...
# Unit tests for OpsgenieClient::SignalSciencesIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignalSciencesIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SignalSciencesIntegration.new
  end
  ...
  describe 'test an instance of SignalSciencesIntegration' do
    it 'should create an instance of SignalSciencesIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SignalSciencesIntegration)
    end
  end
