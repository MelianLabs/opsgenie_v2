...
# Unit tests for OpsgenieClient::AzureOMSIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AzureOMSIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AzureOMSIntegration.new
  end
  ...
  describe 'test an instance of AzureOMSIntegration' do
    it 'should create an instance of AzureOMSIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AzureOMSIntegration)
    end
  end
