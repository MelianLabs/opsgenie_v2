...
# Unit tests for OpsgenieClient::IcingaIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IcingaIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::IcingaIntegration.new
  end
  ...
  describe 'test an instance of IcingaIntegration' do
    it 'should create an instance of IcingaIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::IcingaIntegration)
    end
  end
