...
# Unit tests for OpsgenieClient::UptrendsEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UptrendsEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::UptrendsEmailIntegration.new
  end
  ...
  describe 'test an instance of UptrendsEmailIntegration' do
    it 'should create an instance of UptrendsEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::UptrendsEmailIntegration)
    end
  end
