...
# Unit tests for OpsgenieClient::DatadogCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DatadogCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::DatadogCallback.new
  end
  ...
  describe 'test an instance of DatadogCallback' do
    it 'should create an instance of DatadogCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::DatadogCallback)
    end
  end
