...
# Unit tests for OpsgenieClient::MattermostCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MattermostCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::MattermostCallback.new
  end
  ...
  describe 'test an instance of MattermostCallback' do
    it 'should create an instance of MattermostCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::MattermostCallback)
    end
  end
