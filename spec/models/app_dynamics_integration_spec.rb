...
# Unit tests for OpsgenieClient::AppDynamicsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AppDynamicsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AppDynamicsIntegration.new
  end
  ...
  describe 'test an instance of AppDynamicsIntegration' do
    it 'should create an instance of AppDynamicsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AppDynamicsIntegration)
    end
  end
