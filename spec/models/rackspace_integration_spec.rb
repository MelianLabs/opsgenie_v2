...
# Unit tests for OpsgenieClient::RackspaceIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RackspaceIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::RackspaceIntegration.new
  end
  ...
  describe 'test an instance of RackspaceIntegration' do
    it 'should create an instance of RackspaceIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::RackspaceIntegration)
    end
  end
