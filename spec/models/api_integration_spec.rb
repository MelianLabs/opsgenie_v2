...
# Unit tests for OpsgenieClient::ApiIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ApiIntegration.new
  end
  ...
  describe 'test an instance of ApiIntegration' do
    it 'should create an instance of ApiIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ApiIntegration)
    end
  end
