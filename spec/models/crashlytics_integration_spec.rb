...
# Unit tests for OpsgenieClient::CrashlyticsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CrashlyticsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CrashlyticsIntegration.new
  end
  ...
  describe 'test an instance of CrashlyticsIntegration' do
    it 'should create an instance of CrashlyticsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CrashlyticsIntegration)
    end
  end
