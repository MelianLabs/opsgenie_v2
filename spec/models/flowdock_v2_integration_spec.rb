...
# Unit tests for OpsgenieClient::FlowdockV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FlowdockV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::FlowdockV2Integration.new
  end
  ...
  describe 'test an instance of FlowdockV2Integration' do
    it 'should create an instance of FlowdockV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::FlowdockV2Integration)
    end
  end
