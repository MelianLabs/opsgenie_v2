...
# Unit tests for OpsgenieClient::JiraServiceDeskCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JiraServiceDeskCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::JiraServiceDeskCallback.new
  end
  ...
  describe 'test an instance of JiraServiceDeskCallback' do
    it 'should create an instance of JiraServiceDeskCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::JiraServiceDeskCallback)
    end
  end
