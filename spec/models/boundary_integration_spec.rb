...
# Unit tests for OpsgenieClient::BoundaryIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BoundaryIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::BoundaryIntegration.new
  end
  ...
  describe 'test an instance of BoundaryIntegration' do
    it 'should create an instance of BoundaryIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::BoundaryIntegration)
    end
  end
