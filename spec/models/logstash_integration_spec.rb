...
# Unit tests for OpsgenieClient::LogstashIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LogstashIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::LogstashIntegration.new
  end
  ...
  describe 'test an instance of LogstashIntegration' do
    it 'should create an instance of LogstashIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::LogstashIntegration)
    end
  end
