...
# Unit tests for OpsgenieClient::AtatusIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AtatusIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AtatusIntegration.new
  end
  ...
  describe 'test an instance of AtatusIntegration' do
    it 'should create an instance of AtatusIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AtatusIntegration)
    end
  end
