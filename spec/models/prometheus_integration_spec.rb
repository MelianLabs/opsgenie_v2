...
# Unit tests for OpsgenieClient::PrometheusIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrometheusIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::PrometheusIntegration.new
  end
  ...
  describe 'test an instance of PrometheusIntegration' do
    it 'should create an instance of PrometheusIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::PrometheusIntegration)
    end
  end
