...
# Unit tests for OpsgenieClient::HeartbeatIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HeartbeatIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::HeartbeatIntegration.new
  end
  ...
  describe 'test an instance of HeartbeatIntegration' do
    it 'should create an instance of HeartbeatIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::HeartbeatIntegration)
    end
  end
