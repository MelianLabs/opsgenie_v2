...
# Unit tests for OpsgenieClient::XPackAlertingIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XPackAlertingIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::XPackAlertingIntegration.new
  end
  ...
  describe 'test an instance of XPackAlertingIntegration' do
    it 'should create an instance of XPackAlertingIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::XPackAlertingIntegration)
    end
  end
  ...
  describe 'test attribute "eswatcher_action_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "eswatcher_host_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
