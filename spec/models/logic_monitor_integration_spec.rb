...
# Unit tests for OpsgenieClient::LogicMonitorIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LogicMonitorIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::LogicMonitorIntegration.new
  end
  ...
  describe 'test an instance of LogicMonitorIntegration' do
    it 'should create an instance of LogicMonitorIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::LogicMonitorIntegration)
    end
  end
