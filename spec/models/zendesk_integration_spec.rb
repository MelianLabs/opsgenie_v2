...
# Unit tests for OpsgenieClient::ZendeskIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZendeskIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ZendeskIntegration.new
  end
  ...
  describe 'test an instance of ZendeskIntegration' do
    it 'should create an instance of ZendeskIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ZendeskIntegration)
    end
  end
