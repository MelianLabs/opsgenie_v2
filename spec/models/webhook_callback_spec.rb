...
# Unit tests for OpsgenieClient::WebhookCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::WebhookCallback.new
  end
  ...
  describe 'test an instance of WebhookCallback' do
    it 'should create an instance of WebhookCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::WebhookCallback)
    end
  end
