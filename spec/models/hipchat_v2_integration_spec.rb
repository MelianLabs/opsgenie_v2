...
# Unit tests for OpsgenieClient::HipchatV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HipchatV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::HipchatV2Integration.new
  end
  ...
  describe 'test an instance of HipchatV2Integration' do
    it 'should create an instance of HipchatV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::HipchatV2Integration)
    end
  end
