...
# Unit tests for OpsgenieClient::DNSCheckIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DNSCheckIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::DNSCheckIntegration.new
  end
  ...
  describe 'test an instance of DNSCheckIntegration' do
    it 'should create an instance of DNSCheckIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::DNSCheckIntegration)
    end
  end
