...
# Unit tests for OpsgenieClient::UptimeRobotIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UptimeRobotIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::UptimeRobotIntegration.new
  end
  ...
  describe 'test an instance of UptimeRobotIntegration' do
    it 'should create an instance of UptimeRobotIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::UptimeRobotIntegration)
    end
  end
