...
# Unit tests for OpsgenieClient::AlertSiteIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlertSiteIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AlertSiteIntegration.new
  end
  ...
  describe 'test an instance of AlertSiteIntegration' do
    it 'should create an instance of AlertSiteIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AlertSiteIntegration)
    end
  end
