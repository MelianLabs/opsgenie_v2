...
# Unit tests for OpsgenieClient::KayakoCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KayakoCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::KayakoCallback.new
  end
  ...
  describe 'test an instance of KayakoCallback' do
    it 'should create an instance of KayakoCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::KayakoCallback)
    end
  end
