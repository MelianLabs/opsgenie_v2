...
# Unit tests for OpsgenieClient::RingCentralGlipIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RingCentralGlipIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::RingCentralGlipIntegration.new
  end
  ...
  describe 'test an instance of RingCentralGlipIntegration' do
    it 'should create an instance of RingCentralGlipIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::RingCentralGlipIntegration)
    end
  end
