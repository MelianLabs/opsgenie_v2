...
# Unit tests for OpsgenieClient::ObserviumV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ObserviumV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ObserviumV2Integration.new
  end
  ...
  describe 'test an instance of ObserviumV2Integration' do
    it 'should create an instance of ObserviumV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ObserviumV2Integration)
    end
  end
