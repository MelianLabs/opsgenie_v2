...
# Unit tests for OpsgenieClient::JiraIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JiraIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::JiraIntegration.new
  end
  ...
  describe 'test an instance of JiraIntegration' do
    it 'should create an instance of JiraIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::JiraIntegration)
    end
  end
