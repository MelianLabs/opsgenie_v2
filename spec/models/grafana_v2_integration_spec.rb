...
# Unit tests for OpsgenieClient::GrafanaV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GrafanaV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::GrafanaV2Integration.new
  end
  ...
  describe 'test an instance of GrafanaV2Integration' do
    it 'should create an instance of GrafanaV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::GrafanaV2Integration)
    end
  end
