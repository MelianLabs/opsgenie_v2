...
# Unit tests for OpsgenieClient::ListUsersResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListUsersResponse' do
  before do
    # run before each test
    @instance = OpsgenieClient::ListUsersResponse.new
  end
  ...
  describe 'test an instance of ListUsersResponse' do
    it 'should create an instance of ListUsersResponse' do
      expect(@instance).to be_instance_of(OpsgenieClient::ListUsersResponse)
    end
  end
