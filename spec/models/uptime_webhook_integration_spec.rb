...
# Unit tests for OpsgenieClient::UptimeWebhookIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UptimeWebhookIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::UptimeWebhookIntegration.new
  end
  ...
  describe 'test an instance of UptimeWebhookIntegration' do
    it 'should create an instance of UptimeWebhookIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::UptimeWebhookIntegration)
    end
  end
