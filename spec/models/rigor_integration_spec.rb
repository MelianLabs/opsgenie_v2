...
# Unit tests for OpsgenieClient::RigorIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RigorIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::RigorIntegration.new
  end
  ...
  describe 'test an instance of RigorIntegration' do
    it 'should create an instance of RigorIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::RigorIntegration)
    end
  end
