...
# Unit tests for OpsgenieClient::AmazonRoute53HealthCheckIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonRoute53HealthCheckIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AmazonRoute53HealthCheckIntegration.new
  end
  ...
  describe 'test an instance of AmazonRoute53HealthCheckIntegration' do
    it 'should create an instance of AmazonRoute53HealthCheckIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AmazonRoute53HealthCheckIntegration)
    end
  end
