...
# Unit tests for OpsgenieClient::CopperEggIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CopperEggIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CopperEggIntegration.new
  end
  ...
  describe 'test an instance of CopperEggIntegration' do
    it 'should create an instance of CopperEggIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CopperEggIntegration)
    end
  end
