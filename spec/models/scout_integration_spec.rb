...
# Unit tests for OpsgenieClient::ScoutIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScoutIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ScoutIntegration.new
  end
  ...
  describe 'test an instance of ScoutIntegration' do
    it 'should create an instance of ScoutIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ScoutIntegration)
    end
  end
