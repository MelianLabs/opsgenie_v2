...
# Unit tests for OpsgenieClient::PapertrailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PapertrailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::PapertrailIntegration.new
  end
  ...
  describe 'test an instance of PapertrailIntegration' do
    it 'should create an instance of PapertrailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::PapertrailIntegration)
    end
  end
