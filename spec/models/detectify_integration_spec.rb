...
# Unit tests for OpsgenieClient::DetectifyIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DetectifyIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::DetectifyIntegration.new
  end
  ...
  describe 'test an instance of DetectifyIntegration' do
    it 'should create an instance of DetectifyIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::DetectifyIntegration)
    end
  end
