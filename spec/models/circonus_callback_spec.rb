...
# Unit tests for OpsgenieClient::CirconusCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CirconusCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::CirconusCallback.new
  end
  ...
  describe 'test an instance of CirconusCallback' do
    it 'should create an instance of CirconusCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::CirconusCallback)
    end
  end
