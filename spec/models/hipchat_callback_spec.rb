...
# Unit tests for OpsgenieClient::HipchatCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HipchatCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::HipchatCallback.new
  end
  ...
  describe 'test an instance of HipchatCallback' do
    it 'should create an instance of HipchatCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::HipchatCallback)
    end
  end
