...
# Unit tests for OpsgenieClient::ZenossIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZenossIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ZenossIntegration.new
  end
  ...
  describe 'test an instance of ZenossIntegration' do
    it 'should create an instance of ZenossIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ZenossIntegration)
    end
  end
