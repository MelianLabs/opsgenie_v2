...
# Unit tests for OpsgenieClient::OutgoingCallbackNew
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OutgoingCallbackNew' do
  before do
    # run before each test
    @instance = OpsgenieClient::OutgoingCallbackNew.new
  end
  ...
  describe 'test an instance of OutgoingCallbackNew' do
    it 'should create an instance of OutgoingCallbackNew' do
      expect(@instance).to be_instance_of(OpsgenieClient::OutgoingCallbackNew)
    end
  end
