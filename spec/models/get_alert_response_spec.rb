...
# Unit tests for OpsgenieClient::GetAlertResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAlertResponse' do
  before do
    # run before each test
    @instance = OpsgenieClient::GetAlertResponse.new
  end
  ...
  describe 'test an instance of GetAlertResponse' do
    it 'should create an instance of GetAlertResponse' do
      expect(@instance).to be_instance_of(OpsgenieClient::GetAlertResponse)
    end
  end
