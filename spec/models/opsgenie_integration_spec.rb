...
# Unit tests for OpsgenieClient::OpsgenieIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OpsgenieIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::OpsgenieIntegration.new
  end
  ...
  describe 'test an instance of OpsgenieIntegration' do
    it 'should create an instance of OpsgenieIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::OpsgenieIntegration)
    end
  end
  ...
  describe 'test attribute "destination_api_key"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
