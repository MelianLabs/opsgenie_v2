...
# Unit tests for OpsgenieClient::ComposeIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComposeIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::ComposeIntegration.new
  end
  ...
  describe 'test an instance of ComposeIntegration' do
    it 'should create an instance of ComposeIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::ComposeIntegration)
    end
  end
