...
# Unit tests for OpsgenieClient::BidirectionalCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BidirectionalCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::BidirectionalCallback.new
  end
  ...
  describe 'test an instance of BidirectionalCallback' do
    it 'should create an instance of BidirectionalCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::BidirectionalCallback)
    end
  end
