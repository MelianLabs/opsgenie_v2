...
# Unit tests for OpsgenieClient::SysdigCloudIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SysdigCloudIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::SysdigCloudIntegration.new
  end
  ...
  describe 'test an instance of SysdigCloudIntegration' do
    it 'should create an instance of SysdigCloudIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::SysdigCloudIntegration)
    end
  end
