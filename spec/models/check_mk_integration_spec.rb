...
# Unit tests for OpsgenieClient::CheckMKIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CheckMKIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::CheckMKIntegration.new
  end
  ...
  describe 'test an instance of CheckMKIntegration' do
    it 'should create an instance of CheckMKIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::CheckMKIntegration)
    end
  end
