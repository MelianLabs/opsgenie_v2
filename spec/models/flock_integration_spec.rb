...
# Unit tests for OpsgenieClient::FlockIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FlockIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::FlockIntegration.new
  end
  ...
  describe 'test an instance of FlockIntegration' do
    it 'should create an instance of FlockIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::FlockIntegration)
    end
  end
