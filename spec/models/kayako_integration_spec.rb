...
# Unit tests for OpsgenieClient::KayakoIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KayakoIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::KayakoIntegration.new
  end
  ...
  describe 'test an instance of KayakoIntegration' do
    it 'should create an instance of KayakoIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::KayakoIntegration)
    end
  end
