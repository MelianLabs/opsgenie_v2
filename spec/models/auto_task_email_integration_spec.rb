...
# Unit tests for OpsgenieClient::AutoTaskEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AutoTaskEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AutoTaskEmailIntegration.new
  end
  ...
  describe 'test an instance of AutoTaskEmailIntegration' do
    it 'should create an instance of AutoTaskEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AutoTaskEmailIntegration)
    end
  end
