...
# Unit tests for OpsgenieClient::LibratoIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LibratoIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::LibratoIntegration.new
  end
  ...
  describe 'test an instance of LibratoIntegration' do
    it 'should create an instance of LibratoIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::LibratoIntegration)
    end
  end
