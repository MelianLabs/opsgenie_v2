...
# Unit tests for OpsgenieClient::RunscopeIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RunscopeIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::RunscopeIntegration.new
  end
  ...
  describe 'test an instance of RunscopeIntegration' do
    it 'should create an instance of RunscopeIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::RunscopeIntegration)
    end
  end
