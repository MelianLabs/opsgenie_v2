...
# Unit tests for OpsgenieClient::FreshdeskCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FreshdeskCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::FreshdeskCallback.new
  end
  ...
  describe 'test an instance of FreshdeskCallback' do
    it 'should create an instance of FreshdeskCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::FreshdeskCallback)
    end
  end
