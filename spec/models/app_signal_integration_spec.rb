...
# Unit tests for OpsgenieClient::AppSignalIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AppSignalIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AppSignalIntegration.new
  end
  ...
  describe 'test an instance of AppSignalIntegration' do
    it 'should create an instance of AppSignalIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AppSignalIntegration)
    end
  end
