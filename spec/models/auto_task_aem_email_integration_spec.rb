...
# Unit tests for OpsgenieClient::AutoTaskAEMEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AutoTaskAEMEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::AutoTaskAEMEmailIntegration.new
  end
  ...
  describe 'test an instance of AutoTaskAEMEmailIntegration' do
    it 'should create an instance of AutoTaskAEMEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::AutoTaskAEMEmailIntegration)
    end
  end
