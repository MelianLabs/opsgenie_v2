...
# Unit tests for OpsgenieClient::NotificationRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationRule' do
  before do
    # run before each test
    @instance = OpsgenieClient::NotificationRule.new
  end
  ...
  describe 'test an instance of NotificationRule' do
    it 'should create an instance of NotificationRule' do
      expect(@instance).to be_instance_of(OpsgenieClient::NotificationRule)
    end
  end
