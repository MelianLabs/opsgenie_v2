...
# Unit tests for OpsgenieClient::PingdomV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PingdomV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieClient::PingdomV2Integration.new
  end
  ...
  describe 'test an instance of PingdomV2Integration' do
    it 'should create an instance of PingdomV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieClient::PingdomV2Integration)
    end
  end
