...
# Unit tests for OpsgenieClient::EvidentIOIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EvidentIOIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::EvidentIOIntegration.new
  end
  ...
  describe 'test an instance of EvidentIOIntegration' do
    it 'should create an instance of EvidentIOIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::EvidentIOIntegration)
    end
  end
