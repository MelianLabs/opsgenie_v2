...
# Unit tests for OpsgenieClient::LogglyIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LogglyIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::LogglyIntegration.new
  end
  ...
  describe 'test an instance of LogglyIntegration' do
    it 'should create an instance of LogglyIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::LogglyIntegration)
    end
  end
