...
# Unit tests for OpsgenieClient::StackdriverCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StackdriverCallback' do
  before do
    # run before each test
    @instance = OpsgenieClient::StackdriverCallback.new
  end
  ...
  describe 'test an instance of StackdriverCallback' do
    it 'should create an instance of StackdriverCallback' do
      expect(@instance).to be_instance_of(OpsgenieClient::StackdriverCallback)
    end
  end
