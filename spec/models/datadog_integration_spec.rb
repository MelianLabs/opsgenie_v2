...
# Unit tests for OpsgenieClient::DatadogIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DatadogIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::DatadogIntegration.new
  end
  ...
  describe 'test an instance of DatadogIntegration' do
    it 'should create an instance of DatadogIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::DatadogIntegration)
    end
  end
