...
# Unit tests for OpsgenieClient::TidewaysIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TidewaysIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::TidewaysIntegration.new
  end
  ...
  describe 'test an instance of TidewaysIntegration' do
    it 'should create an instance of TidewaysIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::TidewaysIntegration)
    end
  end
