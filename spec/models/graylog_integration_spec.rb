...
# Unit tests for OpsgenieClient::GraylogIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GraylogIntegration' do
  before do
    # run before each test
    @instance = OpsgenieClient::GraylogIntegration.new
  end
  ...
  describe 'test an instance of GraylogIntegration' do
    it 'should create an instance of GraylogIntegration' do
      expect(@instance).to be_instance_of(OpsgenieClient::GraylogIntegration)
    end
  end
