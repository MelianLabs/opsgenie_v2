...
# Unit tests for OpsgenieClient::ScheduleOverrideApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScheduleOverrideApi' do
  before do
    # run before each test
    @instance = OpsgenieClient::ScheduleOverrideApi.new
  end
  ...
  describe 'test an instance of ScheduleOverrideApi' do
    it 'should create an instance of ScheduleOverrideApi' do
      expect(@instance).to be_instance_of(OpsgenieClient::ScheduleOverrideApi)
    end
  end
